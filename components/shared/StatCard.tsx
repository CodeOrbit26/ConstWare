...
export function StatCard({ 
  ...
  return (
    <div className={cn(
      ...
      {/* Icon top-right */}
      {Icon && (
        <div className={cn("absolute top-6 right-1 bg-white p-2 rounded-xl flex items-center h-10 w-10 border border-slate-100 dark:border-slate-800 shadow-sm transition-transform group-hover:scale-110", iconClassName)}>
