                     ...
                     <tr key={worker.id} className="hover:bg-slate-50 transition-colors">
                        <td className="p-4 pl-6">
                           <div className="flex items-center gap-3">
                              <Avatar size="sm" src={worker.photoUrl} initials={worker.name.substring(0,2).toUpperCase()} className="rounded-xl" />
                              <div className="space-y-0.5">
                                 <p className="text-xs font-black text-navy uppercase tracking-tight">{worker.name}</p>
