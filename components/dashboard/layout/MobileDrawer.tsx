    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className="mt-auto pt-4 border-t border-slate-800/50 shrink-0 space-y-3">
          <div className="flex items-center p-2 rounded-xl bg-slate-900/50 border border-slate-800/40">
            <Avatar initials={user.initials} size="sm" className="bg-slate-700 text-white shadow-sm shrink-0" />
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Link href="/contractor/settings" className="w-full">
              <Button 
                variant="ghost" 
                className="w-full text-slate-400 hover:text-primary hover:bg-primary/10 transition-all text-xs h-9 rounded-xl justify-center font-semibold border border-slate-800/30"
                onClick={onClose}
              >
            ...
            <Button 
              variant="ghost" 
              className="text-slate-400 hover:text-rose-500 hover:bg-rose-500/10 transition-all text-xs h-9 rounded-xl justify-center font-semibold border border-slate-800/30"
              onClick={() => onClose()}
            >
