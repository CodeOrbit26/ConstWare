    ...
    <Popover>
      ...
      <PopoverContent className="w-[340px] p-0 mr-4 mt-2 shadow-2xl rounded-2xl overflow-hidden border-none" align="end">
        ...
        <div className="p-3 bg-slate-50 border-t">
           <Button variant="ghost" asChild className="w-full text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-primary h-8">
              <Link href="/contractor/alerts" className="flex items-center justify-center">
