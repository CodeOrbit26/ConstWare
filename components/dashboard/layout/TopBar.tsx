...
import { Search, Menu, Settings, Sun, Moon, Bell, Activity, Wallet } from "lucide-react"
        ...
        <div className="flex items-center justify-end gap-1.5 lg:gap-3 w-1/4 lg:w-auto shrink-0">
          ...
          <div className="flex items-center gap-1 lg:gap-2">
            ...
            <Link href="/contractor/settings">
              <Button variant="ghost" size="icon" className="h-10 w-10 text-slate-500 hover:text-primary hover:bg-primary/10 transition-all rounded-xl">
