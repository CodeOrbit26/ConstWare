  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50 dark:bg-slate-950 font-sans">
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between bg-navy p-16 text-white relative overflow-hidden">
        ...
        <div className="z-10 flex items-center justify-between border-t border-white/10 pt-8 mt-12 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
          <div className="flex items-center gap-4">
             <div className="flex -space-x-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="h-8 w-8 rounded-full border-2 border-navy bg-slate-800 flex items-center justify-center text-[10px] font-bold">
                    TC
                  </div>
                ))}
             </div>
             <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Trusted by 500+ Top Contractors</p>
          </div>
