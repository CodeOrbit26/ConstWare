...
export function ExpenditureOverview() {
  ...
  const labourPct = totalExpense > 0 ? Math.round((labourTotal / totalExpense) * 100) : 0
  const materialPct = totalExpense > 0 ? Math.round((materialTotal / totalExpense) * 100) : 0
  const operationsPct = totalExpense > 0 ? 100 - labourPct - materialPct : 0
      ...
      >
        ...
        <div className="relative z-10 space-y-10">
          ...
          <div className="space-y-4">
              ...
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest text-center mt-1">Total expenditure (outflows)</p>
