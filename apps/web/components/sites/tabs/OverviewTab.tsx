      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-card border p-5 shadow-sm">
            ...
            <div className="space-y-4">
              {(site.milestones || [
                { id: 'm1', title: 'Site Setup & Mobilization', date: site.startDate || 'TBD', completed: true },
                { id: 'm2', title: 'Foundation & RCC Structure', date: 'In Progress', completed: false },
                { id: 'm3', title: 'Brickwork & Plastering', date: 'TBD', completed: false },
                { id: 'm4', title: 'Finishing & Handover', date: site.endDate || 'TBD', completed: false }
              ]).map((m, idx, arr) => (
                <div key={m.id} className="relative pl-10">
                  ...
                  {idx !== arr.length - 1 && (
                    <div className="absolute left-3 top-7 w-0.5 bg-slate-100 dark:bg-slate-800" style={{ height: 'calc(100% + 1rem)' }} />
                  )}
                  <div>
