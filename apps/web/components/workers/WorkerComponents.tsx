...
export function WorkerCard({ worker, index = 0, viewMode = 'grid' }: { worker: Worker, index?: number, viewMode?: 'grid' | 'list' }) {
  ...
  const workerName = `${worker.firstName || ""} ${worker.lastName || ""}`.trim() || "Unknown Worker"
    ...
    return (
      ...
      >
        <div className="flex items-center gap-6">
          ...
          <div>
            <h4 className="font-exrabold text-slate-900 dark:text-white group-hover:text-primary transition-colors tracking-tight text-[17px]">{workerName}</h4>
      ...
      <div className="p-8 relative z-10">
        <div className="flex items-start justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-extrabold text-slate-900 dark:text-white group-hover:text-primary transition-colors tracking-tight text-lg">{workerName}</h4>
