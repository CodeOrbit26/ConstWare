            ...
            <div key={worker.id} className="p-6 flex items-center justify-between group/item hover:bg-slate-50 dark:hover:bg-slate-900 transition-all rounded-[2rem]">
              <div className="flex items-center gap-6">
                <div className="relative">
                   <Avatar initials={workerName.charAt(0)} size="md" className="bg-slate-900 text-white font-black border-4 border-white dark:border-slate-800" />
                   <div className={cn(
                ...
                <div className="space-y-0.5">
                  <p className="text-lg font-black text-slate-900 dark:text-white tracking-tight italic uppercase">{workerName}</p>
